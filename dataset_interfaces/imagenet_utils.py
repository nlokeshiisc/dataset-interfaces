...
IMAGENET_IDX_TO_SYNSET = {
    ...
    "180": {
        "id": "n02093428",
        "label": "American Staffordshire terrier, Staffordshire terrier, Americanit bull terrier, pi bull terrier",
    },
    ...
    "319": {
        "id": "n02268443",
        "label": "dragonfly, darning needle, devil's darning needle, sewing needl snake feeder, snak doctor, mosquito hawk, skeeter hawk",
    },
    ...
    "349": {
        "id": "n02415577",
        "label": "bighorn, bighorn sheep, cimarron, Rocky Mountain bighorn, RockMountain sheep, Ovi canadensis",
    },
    ...
    "412": {
        "id": "n02747177",
        "label": "ashcan, trash can, garbage can, wastebin, ash bin, ash-bin, hbin, dustbin, tras barrel, trash bin",
    },
    ...
    "986": {
        "id": "n12057211",
        "label": "yellow lady's slipper, yellow lady-slipper, Cypripedium lceolus, Cypripediu parviflorum",
    },
...
sysnet_to_clsid = {}
sysnet_to_clsname = {}
for idx, idx_dict in IMAGENET_IDX_TO_SYNSET.items():
    sysnet_to_clsid[idx_dict["id"]] = eval(idx)
    sysnet_to_clsname[idx_dict["id"]] = idx_dict["label"]
